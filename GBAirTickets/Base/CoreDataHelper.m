...
- (void)setup {
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"CoreBase" withExtension:@"momd"];
...
- (void)addToFavorite:(Ticket *)ticket {
    ...
    favorite.price = ticket.price.integerValue;
    favorite.airline = ticket.airline;
    favorite.departure = ticket.departure;
    favorite.expires = ticket.expires;
    favorite.flightNumber = ticket.flightNumber.integerValue;
